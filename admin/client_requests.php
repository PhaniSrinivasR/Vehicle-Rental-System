					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT client.id_no,client.fname,client.phone,cars.car_name,cars.hire_cost,client.status 
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['id_no'];?>)" class="ico del">Approve</a><a href="#" class="ico edit">Delete</a></td>
							</tr>
							<?php
								}
							?>
