				...
				<div class="box">
					...
					<?php
							if(isset($_POST['send'])){
								...
								//echo "123";
								$forsidQ = 	"SELECT * FROM `subscribers` where emailid='$email1'";
								$e = $conn->query($forsidQ);
								#echo $e;
								$e1 = $e->fetch_assoc();
								$side = $e1['sid'];
								//echo $side;
								//----------executed til here
								$qr = "INSERT INTO cars (car_id,image, car_name,car_type,hire_cost,capacity,status,sid) 
													VALUES (NULL,'$image','$car_name','$car_type','$hire_cost','$capacity','Available','$side')";
